...
shaker bed) live in the experimental version, channel_banger_experimental, from
which this module borrows its shared style, section and layer definitions.
"""
...
from channel_banger_experimental import (
    CHORD_RHYTHMS,
    PROGRESSIONS,
    SCALES,
    STYLES,
